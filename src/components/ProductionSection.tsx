    ...
    <section className="py-24 px-6 bg-black">
      <div className="container mx-auto max-w-7xl">
        <div className="grid gap-12 md:grid-cols-2">
          <div className="overflow-hidden rounded-[2rem] border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.6)]">
            <img
              src="/chi.jpeg"
              alt="Chicago production advantage"
              className="h-full w-full object-cover"
            />
            <div className="border-t border-white/15 bg-black/70 px-6 py-4 text-xs uppercase tracking-[0.5em] text-white/70">
              Chicago and Midwest talent base
            </div>
          </div>
          <div className="space-y-8 text-right">
            ...
            <div className="clear-both">
              ...
              <h3 className="text-9xl font-black text-primary mb-6">30%</h3>
